...
_This post is adapted from an article I wrote on the [arcadisgen.com](https://www.arcadisgen.com/en/what-we-do/insights) website..._
...
Tackling the second stage (too much data) can look different for different cases. Sometimes tailoring the scale of the data and the model to the scale of the problem is what is needed. Other times it is about constraining the possible solutions. Many Electricity Distribution Network Operators collect data vastly in excess of what is required for the UK regulated CNAIM methodology. However, the benefit of using a published methodology is consistency, guaranteed compliance and interpretability. Some clients use our pre-build asset class models as is for internal and external reporting. For others, it becomes a template to customise for specific business use cases (work packaging, for example).  
