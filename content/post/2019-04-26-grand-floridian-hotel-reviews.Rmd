...
The data for this analysis was obtained from the reviews posted on TripAdvisor. I used RSelenium and rvest to extract the data from the first 3000 dynamic web-pages on the TripAdvisor site, which was 2,350 reviews in total. The code used to do this is published on my GitHub [here](https://github.com/mikaylaedwards/gf_reviews/blob/master/gf_reviews.Rmd) 

Here, I load the the Rda file I saved from that extraction. 
