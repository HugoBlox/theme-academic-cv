...
Se desiderate, potete anche dormire al bivacco, che è provvisto di letti e (forse) materassi. Avrete solo bisogno di sacchi a pelo caldi, visto che la temperatura potrebbe facilmente raggiungere i -15°C.
...
#### Il pranzo di APAZAF
Organizzeremo il pranzo basandoci su:

bla bla

#### E se piove?
Non piove, abbiamo accordi precisi con le autorità compententi. Se per una misteriosa congiunzione astrale dovesse piovere, faremo una battaglia di palle di pioggia.

#### Costo 
Nessun prezzo, ma donazione raccomandata di 5/10€?
...
Osservate che avrete probabilmente bisogno di un'auto per poter approfittare di tutte le attrazioni del Bellunese. Un buon sito con informazioni aggiornate su territorio e eventi è [AdorableBelluno](http://adorable.belluno.it/).

## Disclaimer
Tutti i luoghi, orari e date sono soggetti a modifiche senza preavviso da parte di APAZAF. Informazioni al riguardo saranno pibblicate sul [sito](/it/#news) della GBPN appena possibile.
