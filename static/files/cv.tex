...
\begin{rSection}{Short Bio}
	I’m an undergraduate student passionates in the fields of machine learning ,deep learning and algorithm. sI spent my first two years of college life in Shandong University which equipped me with solid programming and mathematics skills. I am currently doing research on machine learning, in particular, variational inferences in ANU, hoping to get research opportunities in relative fields.
\end{rSection}
%----------------------------------------------------------------------------------------
%	EDUCATION SECTION
%----------------------------------------------------------------------------------------
